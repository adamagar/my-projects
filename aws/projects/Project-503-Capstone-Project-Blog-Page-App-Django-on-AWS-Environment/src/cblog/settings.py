...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.ciwmg5tki7yk.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'adam-blogpage' # please enter your s3 bucket name
