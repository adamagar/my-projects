...
app.config['MYSQL_DATABASE_HOST'] = 'adam-database.ciwmg5tki7yk.us-east-1.rds.amazonaws.com'
app.config['MYSQL_DATABASE_USER'] = 'admin'
app.config['MYSQL_DATABASE_PASSWORD'] = 'Awesome_1'
app.config['MYSQL_DATABASE_DB'] = 'adambase'
